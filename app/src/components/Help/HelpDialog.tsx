  ...
  return (
    <Dialog open={isOpen} onOpenChange={close}>
      ...
      <DialogContent>
        ...
        <HotKey hotKeys={[[envString.altOrOption, "N"]]} text={<Localized name="new-song" />} />
        <HotKey hotKeys={[[envString.cmdOrCtrl, "O"]]} text={<Localized name="open-song" />} />
        <HotKey hotKeys={[[envString.cmdOrCtrl, "S"]]} text={<Localized name="save-song" />} />
        <HotKey hotKeys={[[envString.cmdOrCtrl, "Shift", "S"]]} text={<Localized name="save-as" />} />
